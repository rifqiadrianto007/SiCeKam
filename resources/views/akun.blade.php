...
<head>
    ...
    <title>SiCekam - Manajemen Pengguna</title>
        ...
        <div class="fixed flex flex-col top-0 left-0 w-64 bg-indigo-500 h-full shadow-lg">
            ...
            <div class="overflow-y-auto overflow-x-hidden flex-grow">
                <ul class="flex flex-col space-y-1 py-4">
                    ...
                    <li>
                        <a href="pengguna.html" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-indigo-400 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 pr-6 active-nav border-blue-500 bg-indigo-400">
                            <span class="inline-flex justify-center items-center ml-4">
