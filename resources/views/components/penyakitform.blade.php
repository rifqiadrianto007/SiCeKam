                ...
                <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="w-full md:w-1/2">
                        ...
                        <div class="space-y-4">
                            ...
                            <button id="btn-tambah" class="w-full py-3 px-6 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition flex items-center justify-center text-base font-semibold shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                                Tambah
                            </button>
                        </div>
                    </div>
