                            ...
                            <thead>
                                <tr class="border-b">
                                    ...
                                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase">Nama
                                        Blok</th>
                                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase">Jumlah
                                        Ayam</th>
                                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase">
                                        Kapasitas</th>
                                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase">Hasil
                                        Scan</th>
                                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-500 uppercase">Status
                                    </th>
                ...
                <div class="p-6">
                    ...
                    <form id="formBlok">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="namaBlok" class="w-full px-3 py-2 border border-gray-300 rounded-md"
                                placeholder="Contoh: Blok A" required>
                        </div>

                        <div class="mb-4">
                            <label for="jumlahAyam" class="block text-sm font-medium text-gray-700 mb-1">Jumlah Ayam</label>
                            <input type="number" id="jumlahAyam" class="w-full px-3 py-2 border border-gray-300 rounded-md"
                                min="0" required>
                        </div>

                        <div class="mb-4">
                            <label for="kapasitas" class="block text-sm font-medium text-gray-700 mb-1">Kapasitas</label>
                            <input type="number" id="kapasitas" class="w-full px-3 py-2 border border-gray-300 rounded-md"
                                min="1" required>
                        </div>

                        <div class="mb-4">
                            <label for="scan" class="block text-sm font-medium text-gray-700 mb-1">Hasil Scan</label>
                            <input type="number" id="scan" class="w-full px-3 py-2 border border-gray-300 rounded-md"
                                min="0" required>
                        </div>
        ...
        <div id="modalKonfirmasi" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex hidden items-center justify-center">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-sm">
                <div class="p-6">
                    ...
                    <p class="text-gray-500 mb-6">Apakah Anda yakin ingin menghapus blok ini? Tindakan ini tidak dapat
                        dibatalkan.</p>
