    ...
    <div class="relative bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 overflow-hidden shadow-2xl">
      <div class="p-8">
        ...
        <form class="space-y-5" action="{{ route('register') }}" method="POST" autocomplete="on">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="name" name="name" type="text" required autocomplete="name" class="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-[#4361ee]/50 focus:border-[#4361ee]/50 transition" placeholder="Masukkan Nama" aria-required="true">
                </div>
            </div>
        ...
        <footer class="mt-6 text-center text-sm text-white/80">
          Sudah punya akun? <a href="{{ route('login.page') }}" class="font-medium text-white hover:text-white/80 transition hover:underline focus:outline-none focus:underline">Masuk</a>
        </footer>
      </div>
    </div>
  </div>
